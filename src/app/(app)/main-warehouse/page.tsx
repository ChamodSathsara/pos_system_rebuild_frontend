...
export default function CentralWarehouseDashboard() {
  ...
  return <div className="space-y-6">
    <PageHeader title="Main Warehouse Dashboard" description={warehouse.data ? `${warehouse.data.warehouseName} (${warehouse.data.warehouseCode}) · ${warehouse.data.address || "No address recorded"}` : `Assigned warehouse: ${code}`} actions={<div className="flex gap-2"><Button asChild variant="outline"><Link href="/main-warehouse/damage"><AlertTriangle /> Damage</Link></Button><Button asChild><Link href="/main-warehouse/stock-in"><PackagePlus /> Stock In</Link></Button></div>} />
